...
<table style="width:100%;border:0px;border-spacing:0px;border-collapse:separate;margin-right:auto;margin-left:auto;">
  ...
  <tr>
    ...
    <td style="border: none; padding:2.5%;width:75%;vertical-align:middle">
      ...
      <br>
        {% if post.paper %}
          <a href="{{post.paper}}" style="background-color: #008CBA; color: white; padding: 10px 15px; text-align: center; text-decoration: none; display: inline-block; border-radius: 5px;">Paper</a>
        {% endif %}
        {% if post.code %}
